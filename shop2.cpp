...
// All other item data can be stored here in map previously(static)
...
//it will show the menu(category) of listed item in map
void showdeptMenu()
{
	cout << "- - - - - - - - - - -"
		<< " - -\nCategories\n";
...
void selectedMobile()
{
	...
	if (c1 == 'Y' || c1 == 'y') {
		cout << "Enter respective Item number: ";
		cin >> selectedNum;
		...
		if (selectedNum == 1
			...
			if (selectedNum == 1) {
				...
				do {
					...
					cout << "You have selected Samsung, Quantity is - "<< quantity << endl;
